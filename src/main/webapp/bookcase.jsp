...
<c:if test="${empty bookCases }">
  ...
  <tr>
    <td>
      <a href="#" onClick="window.open('../bookcase_add.jsp','','width=360,height=240')">添加书架信息</a> </td>
  </tr>
</table>
</c:if>
...
<c:forEach items="${bookCases}" var="bc">
  <tr>
    ...
    <td align="center"><a href="#" onClick="window.open('modify.do?id=${bc.id }','','width=360,height=240')">修改</a></td>
    <td align="center"><a href="del.do?id=${bc.id }">删除</a></td>
  </tr>
</c:forEach>
</table></td>
      </tr>
