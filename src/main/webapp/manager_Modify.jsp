	...
	<table height="126"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="190">
          ...
          <input name="name" type="text" readonly value="${manager.name}">        
        </td>
      </tr>
      <tr>
        ...
        <td><table width="100%" height="67" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td width="47%">
            <input name="sysset" type="checkbox" class="noborder" id="sysset" value="1" <c:if test="${p.sysset }">checked</c:if>>系统设置</td>
            <td width="53%">
            <input name="readerset" type="checkbox" class="noborder" id="readerset" value="1" <c:if test="${p.readerset }">checked</c:if>>读者管理</td>
          </tr>
          <tr>
            <td>
            <input name="bookset" type="checkbox" class="noborder" id="bookset" value="1" <c:if test="${p.bookset }">checked</c:if>>图书管理</td>
            <td>
            <input name="borrowback" type="checkbox" class="noborder" id="borrowback" value="1" <c:if test="${p.borrowback }">checked</c:if>>图书借还</td>
          </tr>
          <tr>
            <td height="23">
            <input name="sysquery" type="checkbox" class="noborder" id="sysquery" value="1" <c:if test="${p.sysquery }">checked</c:if>>系统查询</td>
            <td>&nbsp;</td>
          </tr>
        </table>          </td>
      </tr>
