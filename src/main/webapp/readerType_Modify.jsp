...
<table width="292" height="175" border="0" cellpadding="0" cellspacing="0" background="Images/subBG.jpg">
 ...
 <form name="form1" method="post" action="readerType/update.do">
 <input name="id" type="hidden" size="50" value="${readerType.id}"> 
  ...
  <tr>
    ...
    <td width="72%"><input name="name" type="text" size="15" value="${readerType.name }">
      </td>
  </tr>
  <tr>
    <td align="center">可借数量：</td>
    <td><input name="number" type="text" size="15" value="${readerType.number }">
      (本)</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
