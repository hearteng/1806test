...
<table width="292" height="175" border="0" cellpadding="0" cellspacing="0" background="Images/subBG.jpg">
 ...
 <form name="form1" method="post" action="bookType/update.do">
 <input name="id" type="hidden" size="50" value="${bookType.id }"> 
  <table width="100%" height="111" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="100" align="center">类型名称：      </td>
    <td width="198" height="39"><input name="typeName" type="text" size="15" value="${bookType.typeName }">
      </td>
  </tr>
  <tr>
    <td align="center">可借天数：</td>
    <td><input name="days" type="text" size="15" value="${bookType.days }">(天)</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
